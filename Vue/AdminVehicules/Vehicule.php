...
<a href="Adminutilisateurs/utilisateur/<?= $utilisateurEntree['id'] ?>"><h2 id="titreUtilisateurVehicule">-> Voir le profil utilisateur #<?= $this->nettoyer($utilisateurEntree['id']) ?>: <?= $this->nettoyer($utilisateurEntree['prenom']) ?> <?= $this->nettoyer($utilisateurEntree['nom']) ?> <-</h2></a>
